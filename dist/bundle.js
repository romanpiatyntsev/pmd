...
/* WEBPACK VAR INJECTION */(function(global) {function initMap() {
    let map, popup, Popup;

    let elementMap = document.getElementById('map'),
        lat = parseFloat(elementMap.dataset.lat),
        lng = parseFloat(elementMap.dataset.lng);
        customZoom = parseInt(elementMap.dataset.zoom) || 17;
    ...
    popup = new Popup(new google.maps.LatLng(lat, lng), document.getElementById('popup-content'));
    popup.setMap(map);
}
...
// CONCATENATED MODULE: ./assets/js/util.js
function clickEvent() {
...
// CONCATENATED MODULE: ./assets/js/menu.js


function stickyTopLayout () {
...
// EXTERNAL MODULE: ./assets/js/google_map.js
var google_map = __webpack_require__(1);

// EXTERNAL MODULE: ./assets/js/lib/particles.js
var particles = __webpack_require__(3);

// CONCATENATED MODULE: ./assets/js/custom_particles.js
